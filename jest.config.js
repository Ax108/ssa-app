...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    "^@appModules/(.*)$": "<rootDir>/src/modules/app/$1",
    "^@navigation/(.*)$": "<rootDir>/src/modules/navigation/$1",
    "^@home/(.*)$": "<rootDir>/src/modules/home/$1",
    "^@ashram/(.*)$": "<rootDir>/src/modules/ashram/$1",
    "^@satsang/(.*)$": "<rootDir>/src/modules/satsang/$1",
    "^@gallery/(.*)$": "<rootDir>/src/modules/gallery/$1",
    "^@contact/(.*)$": "<rootDir>/src/modules/contact/$1",
    "^@src/(.*)$": "<rootDir>/src/$1",
    "^@/(.*)$": "<rootDir>/$1",
